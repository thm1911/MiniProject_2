...
class PendingOrderItemsAdapter(
    private val onRemoveClicked: (productId: Long) -> Unit
) : ListAdapter<OrderItemRow, PendingOrderItemsAdapter.ItemVH>(DiffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemVH {
        ...
        return ItemVH(binding, onRemoveClicked)
    }
    ...
    class ItemVH(
        ...
        fun bind(item: OrderItemRow) {
            ...
            binding.btnRemove.setOnClickListener { onRemoveClicked(item.productId) }
        }
    }
